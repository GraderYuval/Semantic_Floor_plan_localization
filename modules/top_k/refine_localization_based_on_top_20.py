    ...
    with torch.no_grad():
        for batch_idx, batch in enumerate(test_loader):
            ...
            for i in range(batch_size):
                ...
                best_aug_info = None  # Optionally store augmentation key/info if needed

                # Loop over each candidate and each augmentation inside it
                for candidate_index, candidate_key in enumerate(candidate_keys):
                    ...
                    for aug_key, aug_data in candidate_info["augmentations"].items():
                        ...
                        if candidate_score < best_aug_score:
                            ...
                            best_aug_info = (candidate_key, aug_key)  # For reference
                ...
                cand_o_aug = candidate_pos_best_aug[2].item()
