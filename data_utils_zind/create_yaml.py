...
def main():
    ...
    partition_json_path = (
        "/datadrive2/CRM.AI.Research/TeamFolders/Email/repo_yuval/FloorPlan/Floor_Plan_Localization/data/zind/zind_raw/partition.json"
    )
    
    # Base directory that holds the floor directories.
    base_dir = (
        "/datadrive2/CRM.AI.Research/TeamFolders/Email/repo_yuval/FloorPlan/Floor_Plan_Localization/data/zind/zind_data_set_80_fov"
    )
    
    # Output YAML file path (as requested).
    output_yaml_path = (
        "/datadrive2/CRM.AI.Research/TeamFolders/Email/repo_yuval/FloorPlan/Floor_Plan_Localization/data_utils_zind/split.yaml"
    )
